...
On May 22nd, we had still not received a response from the CvB. We sent another email urging them to respond (first our original message, then translation):
